...
def performConfig(workingDir=None):
    os.makedirs(r"/scap_validation_content/ind_xml/e", exist_ok=True)
    os.makedirs(r"/scap_validation_content/ind_xml/ne", exist_ok=True)
    createFile(r"/scap_validation_content/ind_xml/e/1.xml")
    createFile(r"/scap_validation_content/ind_xml/e/books.xml")
    createFile(r"/scap_validation_content/ind_xml/e/1.txt")
    return
