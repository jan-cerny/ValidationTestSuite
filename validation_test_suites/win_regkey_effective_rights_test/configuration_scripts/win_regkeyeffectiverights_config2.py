...
def performConfig(workingDir=None):
    ...
    hSvt = winreg.CreateKeyEx(hCore, 'SOFTWARE\\Microsoft\\MSMQ\\SCAP_Validation_Tests\\win_rer',0, winreg.KEY_ALL_ACCESS)
    ...
    dacl1.AddAccessAllowedAce(win32security.ACL_REVISION, rights, powerUsersSid)
    dacl1.AddAccessDeniedAce(win32security.ACL_REVISION, rights, guestsSid)
    dacl1.AddAccessDeniedAce(win32security.ACL_REVISION, rights, guestSid)
