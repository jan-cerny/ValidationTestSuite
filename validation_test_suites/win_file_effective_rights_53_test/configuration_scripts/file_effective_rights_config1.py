...
def performConfig(workingDir=None):
    ...
    dacl1.AddAccessAllowedAce(win32security.ACL_REVISION, con.FILE_ALL_ACCESS | con.ACCESS_SYSTEM_SECURITY | con.GENERIC_ALL, guestSid)
    dacl1.AddAccessAllowedAce(win32security.ACL_REVISION, con.FILE_ALL_ACCESS | con.ACCESS_SYSTEM_SECURITY | con.GENERIC_ALL, guestsSid)
