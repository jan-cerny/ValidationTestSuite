...
def performConfig(workingDir=None):
    file_path=r"/scap_validation_content"
    ...
    create_file(r"/scap_validation_content/ind_file_hash/e/md5test.txt",'OVAL Test')
    create_file(r"/scap_validation_content/ind_file_hash/e/sha1test.txt",'OVAL Test')
    create_file(r"/scap_validation_content/ind_file_hash/1e/md5test.txt",'OVAL Test')
    create_file(r"/scap_validation_content/ind_file_hash/e/foo.bar",'OVAL Test')
    return
