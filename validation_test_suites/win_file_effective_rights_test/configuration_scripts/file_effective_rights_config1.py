...
def performConfig(workingDir=None):
    ...
    dacl1.AddAccessAllowedAce(win32security.ACL_REVISION, con.FILE_ALL_ACCESS, guestSid)
    dacl1.AddAccessAllowedAce(win32security.ACL_REVISION, con.FILE_ALL_ACCESS, guestsSid)
